...
返回：几何、零件尺寸、几何最小毛坯、实际加工毛坯及解析方向、H2 原始刀路总工时、六阶段工时、孔加工/粗加工/精加工/倒角去毛刺四类 CNC 工时、推荐/实际路线、预测与物理三轴装夹次数、DFM、3D 预览；不返回平台价格、交期或内部定价信息。
...
${shared}`,
  analyze: `分析一个或多个明确指定的 STEP/STP 文件；一个文件也使用单元素批次。
