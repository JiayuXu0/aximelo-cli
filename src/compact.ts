  ...
  return {
    ...
    machining: item.machining
      ? {
          ...
          setup_count_basis: item.machining.setup_count_basis,
          setup_count_confidence: item.machining.setup_count_confidence,
          physical_setup_count: item.machining.physical_setup_count,
          ...
          route: item.machining.route
            ? {
                ...
                setup_count_basis: item.machining.route.setup_count_basis,
                setup_count_confidence: item.machining.route.setup_count_confidence,
                physical_setup_count: item.machining.route.physical_setup_count,
